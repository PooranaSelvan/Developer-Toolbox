...
export default function ToolCard({ tool, showCategory = true, variant = 'default' }) {
  ...
  return (
    <Link
      ...
      aria-label={`Open ${tool.name} tool`}
    >
<article className="h-full rounded-2xl border border-base-300/40 bg-base-100 p-5 transition-all duration-300 hover:border-primary/20 hover:shadow-xl hover:shadow-primary/[0.08] hover:-translate-y-1 focus-within:border-primary/30">
        <div className="flex items-start gap-3.5">
          <div
            className="w-12 h-12 rounded-xl bg-primary/[0.06] flex items-center justify-center shrink-0 text-primary transition-all duration-300 group-hover:bg-primary/[0.12] group-hover:scale-105 group-hover:shadow-md group-hover:shadow-primary/10"
            aria-hidden="true"
          >
