...
export default function NotFound() {
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <MagicCard className="!rounded-2xl max-w-md w-full" gradientOpacity={0.06}>
        <div className="relative p-10 text-center overflow-hidden">
          ...
          <DotPattern
            ...
            height={24}
            cr={0.6}
            className="opacity-[0.04] text-base-content"
            style={{ maskImage: 'radial-gradient(250px circle at center, white, transparent)', WebkitMaskImage: 'radial-gradient(250px circle at center, white, transparent)' }}
          />
          ...
          >
            <h1 className="text-5xl font-extrabold mb-2">
              <NumberTicker value={404} className="text-error/20" />
            </h1>
